<template>
    ...
    <div class="control">
        <div style="margin-top: 20px;">
            ...
            <div style="margin-top: 15px;background-color: #FFF;padding: 5px 0 5px 10px;border-radius: 5px;"> 
                <span style="font-size: var(--van-cell-font-size)">Stop Shedule(min):</span>
                <van-space > 
